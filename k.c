...
int main(void)
{
    ...
    {
        if (corresponde(x[i]) == 0) // Verifica a validade do número romano introduzido, usando a função corresponde, em de caso qualquer caracter diferente de M,D,C,L,X,V,I retorna 0, garante a assim que o valor inserido pelo utilizador respeita a regra.
            {
