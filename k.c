...
int main(void)
{
    ...
    {
        if (corresponde(x[i]) == 0) // Verifica a validade do número romano introduzido, usando a função corresponde caso qualquer caracter de M,D,C,L,X,V,I retorna 0 validando a assim o valor inserido pelo utilizador.
            {
